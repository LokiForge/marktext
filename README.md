...
<div align="center">
  ...
  <!-- Downloads total -->
  <a href="https://github.com/LokiForge/marktext-dual-sidebar/releases">
    <img src="https://img.shields.io/github/downloads/LokiForge/marktext-dual-sidebar/total.svg" alt="total download">
  </a>
  <!-- Downloads latest release -->
  <a href="https://github.com/LokiForge/marktext-dual-sidebar/releases/latest">
    <img src="https://img.shields.io/github/downloads/LokiForge/marktext-dual-sidebar/latest/total.svg" alt="latest download">
  </a>
  <!-- sponsors -->
...
| :-----------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------: |
| [![Download for macOS](https://img.shields.io/badge/macOS-Download-blue)](https://github.com/LokiForge/marktext-dual-sidebar/releases/latest) | [![Download for Windows](https://img.shields.io/badge/Windows-Download-blue)](https://github.com/LokiForge/marktext-dual-sidebar/releases/latest) | [![Download for Linux](https://img.shields.io/badge/Linux-Download-blue)](https://github.com/LokiForge/marktext-dual-sidebar/releases/latest) |
...
You can either download the latest `marktext-mac-(arm64|x64)-%version%.dmg` from the [release page](https://github.com/LokiForge/marktext-dual-sidebar/releases/latest) or install MarkText using [**homebrew cask**](https://github.com/caskroom/homebrew-cask). To use Homebrew-Cask you just need to have [Homebrew](https://brew.sh/) installed.
...
All binaries for Linux, macOS and Windows can be downloaded from the [release page](https://github.com/LokiForge/marktext-dual-sidebar/releases/latest). If a version is unavailable for your system, then please open an [issue](https://github.com/marktext/marktext/issues).
